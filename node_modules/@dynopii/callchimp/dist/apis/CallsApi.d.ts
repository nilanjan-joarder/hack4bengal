...
import type { CallListResponse, CallReportRequest, CallReportResponse, CallResponse, CallsPostRequest, InboundCallListResponse } from '../models/index';
...
export declare class CallsApi extends runtime.BaseAPI {
     ...
     * Get Call by Id
     */
    callsGetRaw(requestParameters: CallsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CallResponse>>;
    /**
     *
     * Get Call by Id
     */
    callsGet(requestParameters: CallsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CallResponse>;
    /**
     *
     * List Supervisor Inbound Calls
     */
    callsListInboundRaw(requestParameters: CallsListInboundRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<InboundCallListResponse>>;
    /**
     *
     * List Supervisor Inbound Calls
     */
    callsListInbound(requestParameters?: CallsListInboundRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<InboundCallListResponse>;
    /**
     *
     * List Calls
     */
    callsListOutboundRaw(requestParameters: CallsListOutboundRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CallListResponse>>;
    /**
     *
     * List Calls
     */
    callsListOutbound(requestParameters?: CallsListOutboundRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CallListResponse>;
    /**
     *
     * Create a Call
     */
    callsPostRaw(requestParameters: CallsPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CallResponse>>;
    /**
     *
     * Create a Call
     */
    callsPost(requestParameters: CallsPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CallResponse>;
    /**
     *
     * Generate Call Reports
     */
    callsReportsRaw(requestParameters: CallsReportsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CallReportResponse>>;
    /**
     *
     * Generate Call Reports
     */
    callsReports(requestParameters: CallsReportsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CallReportResponse>;
}
