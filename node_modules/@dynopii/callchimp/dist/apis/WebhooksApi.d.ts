...
import type { WebhookListResponse, WebhookRequest, WebhookResponse } from '../models/index';
...
export declare class WebhooksApi extends runtime.BaseAPI {
     ...
     * Get Webhook by Id
     */
    webhooksGetRaw(requestParameters: WebhooksGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WebhookResponse>>;
    /**
     *
     * Get Webhook by Id
     */
    webhooksGet(requestParameters: WebhooksGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WebhookResponse>;
    /**
     *
     * List Webhooks
     */
    webhooksListRaw(requestParameters: WebhooksListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WebhookListResponse>>;
    /**
     *
     * List Webhooks
     */
    webhooksList(requestParameters?: WebhooksListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WebhookListResponse>;
    /**
     *
     * Create a Webhook
     */
    webhooksPostRaw(requestParameters: WebhooksPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WebhookResponse>>;
    /**
     *
     * Create a Webhook
     */
    webhooksPost(requestParameters: WebhooksPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WebhookResponse>;
    /**
     *
     * Update Webhook by Id
     */
    webhooksUpdateRaw(requestParameters: WebhooksUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WebhookResponse>>;
    /**
     *
     * Update Webhook by Id
     */
    webhooksUpdate(requestParameters: WebhooksUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WebhookResponse>;
}
