...
import type { VoiceResponse } from '../models/index';
/**
 *
 */
export declare class VoicesApi extends runtime.BaseAPI {
    /**
     ...
     */
    voicesListRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<VoiceResponse>>>;
    /**
     * Lists available voices for an organization. For a preview of available voices, go to [Voice Garden](https://voices.callchimp.ai/) by Callchimp
     * List Available Voices
     */
    voicesList(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<VoiceResponse>>;
}
