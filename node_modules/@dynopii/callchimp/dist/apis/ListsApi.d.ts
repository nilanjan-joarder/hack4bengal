...
import type { CampaignListsRequest, ListFindRequest, ListsListResponse, ListsRequest, ListsResponse } from '../models/index';
export interface ListsCreateCampaignAndListRequest {
    campaignListsRequest: CampaignListsRequest;
}
export interface ListsDeleteRequest {
    id: number;
}
export interface ListsFindRequest {
    listFindRequest: ListFindRequest;
    page?: number;
}
 ...
 *
 */
export declare class ListsApi extends runtime.BaseAPI {
    /**
     *
     * Create Campaign with Default List
     */
    listsCreateCampaignAndListRaw(requestParameters: ListsCreateCampaignAndListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListsResponse>>;
    /**
     *
     * Create Campaign with Default List
     */
    listsCreateCampaignAndList(requestParameters: ListsCreateCampaignAndListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListsResponse>;
    /**
     *
     * Delete List by Id
     */
    listsDeleteRaw(requestParameters: ListsDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;
    /**
     *
     * Delete List by Id
     */
    listsDelete(requestParameters: ListsDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
    /**
     *
     * Search List by Name or Id
     */
    listsFindRaw(requestParameters: ListsFindRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListsResponse>>;
    /**
     *
     * Search List by Name or Id
     */
    listsFind(requestParameters: ListsFindRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListsResponse>;
    /**
     *
     * Get List by Id
     */
    listsGetRaw(requestParameters: ListsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListsResponse>>;
    /**
     *
     * Get List by Id
     */
    listsGet(requestParameters: ListsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListsResponse>;
    /**
     *
     * List Lists
     */
    listsListRaw(requestParameters: ListsListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListsListResponse>>;
    /**
     *
     * List Lists
     */
    listsList(requestParameters?: ListsListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListsListResponse>;
    /**
     *
     * Create a List
     */
    listsPostRaw(requestParameters: ListsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListsResponse>>;
    /**
     *
     * Create a List
     */
    listsPost(requestParameters: ListsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListsResponse>;
    /**
     *
     * Update List by Id
     */
    listsUpdateRaw(requestParameters: ListsUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ListsResponse>>;
    /**
     *
     * Update List by Id
     */
    listsUpdate(requestParameters: ListsUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListsResponse>;
}
