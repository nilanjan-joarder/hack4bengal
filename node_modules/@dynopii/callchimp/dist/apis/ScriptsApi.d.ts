...
import type { ScriptListResponse, ScriptRequest, ScriptResponse, WebhookResponse } from '../models/index';
...
export interface ScriptsPostRequest {
 ...
 *
 */
export declare class ScriptsApi extends runtime.BaseAPI {
    /**
     *
     * Delete Script by Id
     */
    scriptsDeleteRaw(requestParameters: ScriptsDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;
    /**
     *
     * Delete Script by Id
     */
    scriptsDelete(requestParameters: ScriptsDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
    /**
     *
     * Get Script by Id
     */
    scriptsGetRaw(requestParameters: ScriptsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScriptResponse>>;
    /**
     *
     * Get Script by Id
     */
    scriptsGet(requestParameters: ScriptsGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ScriptResponse>;
    /**
     *
     * List Script
     */
    scriptsListRaw(requestParameters: ScriptsListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScriptListResponse>>;
    /**
     *
     * List Script
     */
    scriptsList(requestParameters?: ScriptsListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ScriptListResponse>;
    /**
     *
     * Create a Script
     */
    scriptsPostRaw(requestParameters: ScriptsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScriptResponse>>;
    /**
     *
     * Create a Script
     */
    scriptsPost(requestParameters: ScriptsPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ScriptResponse>;
    /**
     *
     * Update Script by Id
     */
    scriptsUpdateRaw(requestParameters: ScriptsUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WebhookResponse>>;
    /**
     *
     * Update Script by Id
     */
    scriptsUpdate(requestParameters: ScriptsUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WebhookResponse>;
}
