...
import type { PhoneNumberListResponse } from '../models/index';
 ...
 *
 */
export declare class PhoneNumbersApi extends runtime.BaseAPI {
    /**
     *
     * List Phone Numbers
     */
    phoneNumbersListRaw(requestParameters: PhoneNumbersListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PhoneNumberListResponse>>;
    /**
     *
     * List Phone Numbers
     */
    phoneNumbersList(requestParameters?: PhoneNumbersListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PhoneNumberListResponse>;
}
