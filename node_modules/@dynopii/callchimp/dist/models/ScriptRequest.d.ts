 ...
 */
export declare function instanceOfScriptRequest(value: object): value is ScriptRequest;
export declare function ScriptRequestFromJSON(json: any): ScriptRequest;
export declare function ScriptRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScriptRequest;
export declare function ScriptRequestToJSON(value?: ScriptRequest | null): any;
