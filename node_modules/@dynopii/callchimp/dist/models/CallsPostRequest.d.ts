 ...
 * @export
 */
export declare const CallsPostRequestTransactionAudioGenderEnum: {
    readonly M: "M";
    readonly F: "F";
};
 ...
 */
export declare function instanceOfCallsPostRequest(value: object): value is CallsPostRequest;
export declare function CallsPostRequestFromJSON(json: any): CallsPostRequest;
export declare function CallsPostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallsPostRequest;
export declare function CallsPostRequestToJSON(value?: CallsPostRequest | null): any;
