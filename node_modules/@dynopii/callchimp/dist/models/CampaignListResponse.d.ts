 ...
 */
export declare function instanceOfCampaignListResponse(value: object): value is CampaignListResponse;
export declare function CampaignListResponseFromJSON(json: any): CampaignListResponse;
export declare function CampaignListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignListResponse;
export declare function CampaignListResponseToJSON(value?: CampaignListResponse | null): any;
