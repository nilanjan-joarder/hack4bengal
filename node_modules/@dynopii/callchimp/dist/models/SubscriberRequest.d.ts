 ...
 */
export declare function instanceOfSubscriberRequest(value: object): value is SubscriberRequest;
export declare function SubscriberRequestFromJSON(json: any): SubscriberRequest;
export declare function SubscriberRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriberRequest;
export declare function SubscriberRequestToJSON(value?: SubscriberRequest | null): any;
