 ...
 */
export declare function instanceOfListsRequest(value: object): value is ListsRequest;
export declare function ListsRequestFromJSON(json: any): ListsRequest;
export declare function ListsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListsRequest;
export declare function ListsRequestToJSON(value?: ListsRequest | null): any;
