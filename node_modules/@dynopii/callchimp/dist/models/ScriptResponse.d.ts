 ...
 */
export declare function instanceOfScriptResponse(value: object): value is ScriptResponse;
export declare function ScriptResponseFromJSON(json: any): ScriptResponse;
export declare function ScriptResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScriptResponse;
export declare function ScriptResponseToJSON(value?: ScriptResponse | null): any;
