 ...
 */
export declare function instanceOfCampaignRemoveSuperRequest(value: object): value is CampaignRemoveSuperRequest;
export declare function CampaignRemoveSuperRequestFromJSON(json: any): CampaignRemoveSuperRequest;
export declare function CampaignRemoveSuperRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignRemoveSuperRequest;
export declare function CampaignRemoveSuperRequestToJSON(value?: CampaignRemoveSuperRequest | null): any;
