...
export interface VoiceResponse {
     ...
     * @memberof VoiceResponse
     */
    gender?: VoiceResponseGenderEnum;
}
/**
 * @export
 */
export declare const VoiceResponseGenderEnum: {
    readonly F: "f";
    readonly M: "m";
};
export type VoiceResponseGenderEnum = typeof VoiceResponseGenderEnum[keyof typeof VoiceResponseGenderEnum];
/**
 * Check if a given object implements the VoiceResponse interface.
 */
export declare function instanceOfVoiceResponse(value: object): value is VoiceResponse;
export declare function VoiceResponseFromJSON(json: any): VoiceResponse;
export declare function VoiceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): VoiceResponse;
export declare function VoiceResponseToJSON(value?: VoiceResponse | null): any;
