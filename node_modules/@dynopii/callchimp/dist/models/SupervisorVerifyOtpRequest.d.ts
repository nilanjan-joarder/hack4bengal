 ...
 */
export declare function instanceOfSupervisorVerifyOtpRequest(value: object): value is SupervisorVerifyOtpRequest;
export declare function SupervisorVerifyOtpRequestFromJSON(json: any): SupervisorVerifyOtpRequest;
export declare function SupervisorVerifyOtpRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SupervisorVerifyOtpRequest;
export declare function SupervisorVerifyOtpRequestToJSON(value?: SupervisorVerifyOtpRequest | null): any;
