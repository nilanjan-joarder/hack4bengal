 ...
 */
export declare function instanceOfCampaignListsRequest(value: object): value is CampaignListsRequest;
export declare function CampaignListsRequestFromJSON(json: any): CampaignListsRequest;
export declare function CampaignListsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignListsRequest;
export declare function CampaignListsRequestToJSON(value?: CampaignListsRequest | null): any;
