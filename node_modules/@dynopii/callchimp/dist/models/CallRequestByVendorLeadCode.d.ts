 ...
 */
export declare function instanceOfCallRequestByVendorLeadCode(value: object): value is CallRequestByVendorLeadCode;
export declare function CallRequestByVendorLeadCodeFromJSON(json: any): CallRequestByVendorLeadCode;
export declare function CallRequestByVendorLeadCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallRequestByVendorLeadCode;
export declare function CallRequestByVendorLeadCodeToJSON(value?: CallRequestByVendorLeadCode | null): any;
