 ...
 */
export declare function instanceOfCampaignAddSuperRequest(value: object): value is CampaignAddSuperRequest;
export declare function CampaignAddSuperRequestFromJSON(json: any): CampaignAddSuperRequest;
export declare function CampaignAddSuperRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignAddSuperRequest;
export declare function CampaignAddSuperRequestToJSON(value?: CampaignAddSuperRequest | null): any;
