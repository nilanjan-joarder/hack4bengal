...
export interface InboundCallResponse {
     ...
     * @memberof InboundCallResponse
     */
    supervisor?: InboundCallResponseSupervisor;
    /**
     *
     * @type {string}
     * @memberof InboundCallResponse
 ...
 */
export declare function instanceOfInboundCallResponse(value: object): value is InboundCallResponse;
export declare function InboundCallResponseFromJSON(json: any): InboundCallResponse;
export declare function InboundCallResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InboundCallResponse;
export declare function InboundCallResponseToJSON(value?: InboundCallResponse | null): any;
