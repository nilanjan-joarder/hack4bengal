 ...
 */
export declare function instanceOfPhoneNumberResponse(value: object): value is PhoneNumberResponse;
export declare function PhoneNumberResponseFromJSON(json: any): PhoneNumberResponse;
export declare function PhoneNumberResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PhoneNumberResponse;
export declare function PhoneNumberResponseToJSON(value?: PhoneNumberResponse | null): any;
