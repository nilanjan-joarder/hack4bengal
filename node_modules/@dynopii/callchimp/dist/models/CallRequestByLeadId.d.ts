 ...
 */
export declare function instanceOfCallRequestByLeadId(value: object): value is CallRequestByLeadId;
export declare function CallRequestByLeadIdFromJSON(json: any): CallRequestByLeadId;
export declare function CallRequestByLeadIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallRequestByLeadId;
export declare function CallRequestByLeadIdToJSON(value?: CallRequestByLeadId | null): any;
