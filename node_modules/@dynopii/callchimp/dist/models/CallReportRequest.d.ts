 ...
 */
export declare function instanceOfCallReportRequest(value: object): value is CallReportRequest;
export declare function CallReportRequestFromJSON(json: any): CallReportRequest;
export declare function CallReportRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallReportRequest;
export declare function CallReportRequestToJSON(value?: CallReportRequest | null): any;
