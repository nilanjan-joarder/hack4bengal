 ...
 */
export declare function instanceOfModel4XXResponse(value: object): value is Model4XXResponse;
export declare function Model4XXResponseFromJSON(json: any): Model4XXResponse;
export declare function Model4XXResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Model4XXResponse;
export declare function Model4XXResponseToJSON(value?: Model4XXResponse | null): any;
