 ...
 */
export declare function instanceOfSubscriberUpdateRequest(value: object): value is SubscriberUpdateRequest;
export declare function SubscriberUpdateRequestFromJSON(json: any): SubscriberUpdateRequest;
export declare function SubscriberUpdateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriberUpdateRequest;
export declare function SubscriberUpdateRequestToJSON(value?: SubscriberUpdateRequest | null): any;
