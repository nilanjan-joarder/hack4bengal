 ...
 */
export declare function instanceOfCampaignRemoveSuperResponse(value: object): value is CampaignRemoveSuperResponse;
export declare function CampaignRemoveSuperResponseFromJSON(json: any): CampaignRemoveSuperResponse;
export declare function CampaignRemoveSuperResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignRemoveSuperResponse;
export declare function CampaignRemoveSuperResponseToJSON(value?: CampaignRemoveSuperResponse | null): any;
