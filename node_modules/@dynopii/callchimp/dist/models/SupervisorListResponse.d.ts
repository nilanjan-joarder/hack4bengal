 ...
 */
export declare function instanceOfSupervisorListResponse(value: object): value is SupervisorListResponse;
export declare function SupervisorListResponseFromJSON(json: any): SupervisorListResponse;
export declare function SupervisorListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SupervisorListResponse;
export declare function SupervisorListResponseToJSON(value?: SupervisorListResponse | null): any;
