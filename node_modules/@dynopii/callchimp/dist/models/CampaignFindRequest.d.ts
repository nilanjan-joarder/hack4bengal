 ...
 */
export declare function instanceOfCampaignFindRequest(value: object): value is CampaignFindRequest;
export declare function CampaignFindRequestFromJSON(json: any): CampaignFindRequest;
export declare function CampaignFindRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignFindRequest;
export declare function CampaignFindRequestToJSON(value?: CampaignFindRequest | null): any;
