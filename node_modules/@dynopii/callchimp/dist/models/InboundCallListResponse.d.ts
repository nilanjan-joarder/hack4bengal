 ...
 */
export declare function instanceOfInboundCallListResponse(value: object): value is InboundCallListResponse;
export declare function InboundCallListResponseFromJSON(json: any): InboundCallListResponse;
export declare function InboundCallListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InboundCallListResponse;
export declare function InboundCallListResponseToJSON(value?: InboundCallListResponse | null): any;
