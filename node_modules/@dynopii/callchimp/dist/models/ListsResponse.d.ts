 ...
 */
export declare function instanceOfListsResponse(value: object): value is ListsResponse;
export declare function ListsResponseFromJSON(json: any): ListsResponse;
export declare function ListsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListsResponse;
export declare function ListsResponseToJSON(value?: ListsResponse | null): any;
