 ...
 */
export declare function instanceOfCallListResponse(value: object): value is CallListResponse;
export declare function CallListResponseFromJSON(json: any): CallListResponse;
export declare function CallListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallListResponse;
export declare function CallListResponseToJSON(value?: CallListResponse | null): any;
