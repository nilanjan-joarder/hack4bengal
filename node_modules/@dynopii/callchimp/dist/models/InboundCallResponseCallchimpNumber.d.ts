 ...
 * @export
 */
export declare const InboundCallResponseCallchimpNumberTypeEnum: {
    readonly Jio: "JIO";
 ...
 */
export declare function instanceOfInboundCallResponseCallchimpNumber(value: object): value is InboundCallResponseCallchimpNumber;
export declare function InboundCallResponseCallchimpNumberFromJSON(json: any): InboundCallResponseCallchimpNumber;
export declare function InboundCallResponseCallchimpNumberFromJSONTyped(json: any, ignoreDiscriminator: boolean): InboundCallResponseCallchimpNumber;
export declare function InboundCallResponseCallchimpNumberToJSON(value?: InboundCallResponseCallchimpNumber | null): any;
