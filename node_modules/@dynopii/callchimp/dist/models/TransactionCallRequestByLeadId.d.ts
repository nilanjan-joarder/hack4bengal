...
export interface TransactionCallRequestByLeadId {
     ...
     * @memberof TransactionCallRequestByLeadId
     */
    transactionAudioGender?: TransactionCallRequestByLeadIdTransactionAudioGenderEnum;
    /**
 ...
 * @export
 */
export declare const TransactionCallRequestByLeadIdTransactionAudioGenderEnum: {
    readonly M: "M";
    readonly F: "F";
};
export type TransactionCallRequestByLeadIdTransactionAudioGenderEnum = typeof TransactionCallRequestByLeadIdTransactionAudioGenderEnum[keyof typeof TransactionCallRequestByLeadIdTransactionAudioGenderEnum];
/**
 * Check if a given object implements the TransactionCallRequestByLeadId interface.
 */
export declare function instanceOfTransactionCallRequestByLeadId(value: object): value is TransactionCallRequestByLeadId;
export declare function TransactionCallRequestByLeadIdFromJSON(json: any): TransactionCallRequestByLeadId;
export declare function TransactionCallRequestByLeadIdFromJSONTyped(json: any, ignoreDiscriminator: boolean): TransactionCallRequestByLeadId;
export declare function TransactionCallRequestByLeadIdToJSON(value?: TransactionCallRequestByLeadId | null): any;
