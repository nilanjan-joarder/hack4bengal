 ...
 */
export declare function instanceOfSupervisorVerifyOtpResponse(value: object): value is SupervisorVerifyOtpResponse;
export declare function SupervisorVerifyOtpResponseFromJSON(json: any): SupervisorVerifyOtpResponse;
export declare function SupervisorVerifyOtpResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SupervisorVerifyOtpResponse;
export declare function SupervisorVerifyOtpResponseToJSON(value?: SupervisorVerifyOtpResponse | null): any;
