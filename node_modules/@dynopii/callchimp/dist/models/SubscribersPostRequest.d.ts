 ...
 *
 * @export
 * @interface SubscribersPostRequest
 */
export interface SubscribersPostRequest {
    /**
     *
     * @type {string}
     * @memberof SubscribersPostRequest
     */
    firstName: string;
    /**
     *
 ...
 */
export declare function instanceOfSubscribersPostRequest(value: object): value is SubscribersPostRequest;
export declare function SubscribersPostRequestFromJSON(json: any): SubscribersPostRequest;
export declare function SubscribersPostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscribersPostRequest;
export declare function SubscribersPostRequestToJSON(value?: SubscribersPostRequest | null): any;
