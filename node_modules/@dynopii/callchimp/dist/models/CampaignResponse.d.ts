 ...
 * @export
 */
export declare const CampaignResponseMaxRetryEnum: {
    readonly NUMBER_0: 0;
    readonly NUMBER_1: 1;
    readonly NUMBER_2: 2;
};
 ...
 * @export
 */
export declare const CampaignResponseTypeEnum: {
    readonly Blastout: "blastout";
 ...
 */
export declare function instanceOfCampaignResponse(value: object): value is CampaignResponse;
export declare function CampaignResponseFromJSON(json: any): CampaignResponse;
export declare function CampaignResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignResponse;
export declare function CampaignResponseToJSON(value?: CampaignResponse | null): any;
