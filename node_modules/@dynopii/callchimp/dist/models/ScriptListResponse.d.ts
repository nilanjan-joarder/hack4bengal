 ...
 */
export declare function instanceOfScriptListResponse(value: object): value is ScriptListResponse;
export declare function ScriptListResponseFromJSON(json: any): ScriptListResponse;
export declare function ScriptListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScriptListResponse;
export declare function ScriptListResponseToJSON(value?: ScriptListResponse | null): any;
