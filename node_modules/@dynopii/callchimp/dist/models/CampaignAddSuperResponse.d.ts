 ...
 */
export declare function instanceOfCampaignAddSuperResponse(value: object): value is CampaignAddSuperResponse;
export declare function CampaignAddSuperResponseFromJSON(json: any): CampaignAddSuperResponse;
export declare function CampaignAddSuperResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignAddSuperResponse;
export declare function CampaignAddSuperResponseToJSON(value?: CampaignAddSuperResponse | null): any;
