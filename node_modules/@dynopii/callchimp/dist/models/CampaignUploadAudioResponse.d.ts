 ...
 */
export declare function instanceOfCampaignUploadAudioResponse(value: object): value is CampaignUploadAudioResponse;
export declare function CampaignUploadAudioResponseFromJSON(json: any): CampaignUploadAudioResponse;
export declare function CampaignUploadAudioResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignUploadAudioResponse;
export declare function CampaignUploadAudioResponseToJSON(value?: CampaignUploadAudioResponse | null): any;
