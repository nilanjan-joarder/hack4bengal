 ...
 */
export declare function instanceOfListFindRequest(value: object): value is ListFindRequest;
export declare function ListFindRequestFromJSON(json: any): ListFindRequest;
export declare function ListFindRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListFindRequest;
export declare function ListFindRequestToJSON(value?: ListFindRequest | null): any;
