...
export interface SupervisorRequest {
    ...
    name: string;
    /**
     * [E.164](https://www.twilio.com/docs/glossary/what-e164) formatted phone number of supervisor.
     *
     * @type {string}
     * @memberof SupervisorRequest
     */
    phone: string;
    /**
     * Priority of supervisor in the queue
     * @type {number}
     * @memberof SupervisorRequest
     */
    priority: number;
    /**
     * Current organization id. Can be found in the Callchimp [Settings](https://callchimp.ai/settings) -> Organization tab -> Org ID Column.
     * @type {number}
     * @memberof SupervisorRequest
     */
    organization?: number;
 ...
 */
export declare function instanceOfSupervisorRequest(value: object): value is SupervisorRequest;
export declare function SupervisorRequestFromJSON(json: any): SupervisorRequest;
export declare function SupervisorRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SupervisorRequest;
export declare function SupervisorRequestToJSON(value?: SupervisorRequest | null): any;
