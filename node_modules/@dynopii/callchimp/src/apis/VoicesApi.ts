...
export class VoicesApi extends runtime.BaseAPI {
     ...
     */
    async voicesListRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<VoiceResponse>>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(VoiceResponseFromJSON));
    }
     ...
     * List Available Voices
     */
    async voicesList(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<VoiceResponse>> {
        const response = await this.voicesListRaw(initOverrides);
