...
export class PhoneNumbersApi extends runtime.BaseAPI {
     ...
     * List Phone Numbers
     */
    async phoneNumbersListRaw(requestParameters: PhoneNumbersListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PhoneNumberListResponse>> {
     ...
     * List Phone Numbers
     */
    async phoneNumbersList(requestParameters: PhoneNumbersListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PhoneNumberListResponse> {
        const response = await this.phoneNumbersListRaw(requestParameters, initOverrides);
