...
export class WebhooksApi extends runtime.BaseAPI {
     ...
     * List Webhooks
     */
    async webhooksListRaw(requestParameters: WebhooksListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WebhookListResponse>> {
        const queryParameters: any = {};
     ...
     * List Webhooks
     */
    async webhooksList(requestParameters: WebhooksListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WebhookListResponse> {
    ...
    async webhooksPostRaw(requestParameters: WebhooksPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WebhookResponse>> {
        if (requestParameters['webhookRequest'] == null) {
            throw new runtime.RequiredError(
                'webhookRequest',
                'Required parameter "webhookRequest" was null or undefined when calling webhooksPost().'
            );
        }
    ...
    async webhooksUpdateRaw(requestParameters: WebhooksUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<WebhookResponse>> {
        ...
        if (requestParameters['webhookRequest'] == null) {
            throw new runtime.RequiredError(
                'webhookRequest',
                'Required parameter "webhookRequest" was null or undefined when calling webhooksUpdate().'
            );
        }
