 ...
 * 
 * @export
 * @interface ListFindRequest
 */
export interface ListFindRequest {
    /**
     * 
     * @type {string}
     * @memberof ListFindRequest
     */
    query?: string;
}
 ...
 */
export function instanceOfListFindRequest(value: object): value is ListFindRequest {
    return true;
}

export function ListFindRequestFromJSON(json: any): ListFindRequest {
    return ListFindRequestFromJSONTyped(json, false);
}

export function ListFindRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListFindRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ListFindRequestToJSON(value?: ListFindRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
