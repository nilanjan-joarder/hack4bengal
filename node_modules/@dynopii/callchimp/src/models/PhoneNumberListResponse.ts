 ...
 */
export function instanceOfPhoneNumberListResponse(value: object): value is PhoneNumberListResponse {
    return true;
}
...
export function PhoneNumberListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PhoneNumberListResponse {
    ...
    return {
        ...
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(PhoneNumberResponseFromJSON)),
...
export function PhoneNumberListResponseToJSON(value?: PhoneNumberListResponse | null): any {
    ...
    return {
        ...
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(PhoneNumberResponseToJSON)),
