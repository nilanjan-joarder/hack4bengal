 ...
 * @export
 */
export const TransactionCallRequestByLeadIdTransactionAudioGenderEnum = {
    M: 'M',
    F: 'F'
} as const;
 ...
 */
export function instanceOfTransactionCallRequestByLeadId(value: object): value is TransactionCallRequestByLeadId {
    if (!('lead' in value) || value['lead'] === undefined) return false;
    if (!('transactionVars' in value) || value['transactionVars'] === undefined) return false;
    return true;
}
