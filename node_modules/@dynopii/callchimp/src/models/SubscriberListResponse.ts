...
export function SubscriberListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriberListResponse {
    ...
    return {
        ...
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(SubscriberResponseFromJSON)),
...
export function SubscriberListResponseToJSON(value?: SubscriberListResponse | null): any {
    ...
    return {
        ...
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(SubscriberResponseToJSON)),
