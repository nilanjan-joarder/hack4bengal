...
export function CallListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallListResponse {
    ...
    return {
        ...
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(CallResponseFromJSON)),
...
export function CallListResponseToJSON(value?: CallListResponse | null): any {
    ...
    return {
        ...
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(CallResponseToJSON)),
