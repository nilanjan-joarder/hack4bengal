...
export interface CallsPostRequest {
     ...
     * @memberof CallsPostRequest
     */
    transactionAudioGender?: CallsPostRequestTransactionAudioGenderEnum;
    /**
 ...
 * @export
 */
export const CallsPostRequestTransactionAudioGenderEnum = {
    M: 'M',
    F: 'F'
} as const;
export type CallsPostRequestTransactionAudioGenderEnum = typeof CallsPostRequestTransactionAudioGenderEnum[keyof typeof CallsPostRequestTransactionAudioGenderEnum];


/**
 * Check if a given object implements the CallsPostRequest interface.
 */
export function instanceOfCallsPostRequest(value: object): value is CallsPostRequest {
    ...
    if (!('vendorLeadCode' in value) || value['vendorLeadCode'] === undefined) return false;
    return true;
}
