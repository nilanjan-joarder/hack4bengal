...
export function CampaignListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignListResponse {
    ...
    return {
        ...
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(CampaignResponseFromJSON)),
...
export function CampaignListResponseToJSON(value?: CampaignListResponse | null): any {
    ...
    return {
        ...
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(CampaignResponseToJSON)),
