 ...
 * 
 * @export
 * @interface CampaignListsRequest
 */
export interface CampaignListsRequest {
    /**
     * Campaign and list name
     * @type {string}
     * @memberof CampaignListsRequest
     */
    name: string;
    /**
 ...
 */
export function instanceOfCampaignListsRequest(value: object): value is CampaignListsRequest {
...
export function CampaignListsRequestFromJSON(json: any): CampaignListsRequest {
    return CampaignListsRequestFromJSONTyped(json, false);
}

export function CampaignListsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignListsRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CampaignListsRequestToJSON(value?: CampaignListsRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
