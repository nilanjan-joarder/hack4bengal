...
export function WebhookListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WebhookListResponse {
    ...
    return {
        ...
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(WebhookResponseFromJSON)),
...
export function WebhookListResponseToJSON(value?: WebhookListResponse | null): any {
    ...
    return {
        ...
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(WebhookResponseToJSON)),
