...
export interface ScriptResponse {
    ...
    addedAt?: Date;
    /**
     * A list of campaign identifiers associated with the script.
     * @type {Array<number>}
     * @memberof ScriptResponse
     */
    campaigns?: Array<number>;
    /**
     * An explanation of the script content and its appropriateness.
     * @type {string}
     * @memberof ScriptResponse
     */
    explanation?: string;
    /**
     * The final rating assigned to the script content.
     * @type {string}
     * @memberof ScriptResponse
     */
    finalRating?: string;
    /**
     * Score for dangerous content category.
     * @type {number}
     * @memberof ScriptResponse
     */
    harmCategoryDangerousContentScore?: number;
    /**
     * Score for harassment content category.
     * @type {number}
     * @memberof ScriptResponse
     */
    harmCategoryHarassmentScore?: number;
    /**
     * Score for hate speech content category.
     * @type {number}
     * @memberof ScriptResponse
     */
    harmCategoryHateSpeechScore?: number;
    /**
     * Score for sexually explicit content category.
     * @type {number}
     * @memberof ScriptResponse
     */
    harmCategorySexuallyExplicitScore?: number;
    /**
    ...
    name?: string;
    /**
     * The identifier for the organization associated with the script.
     * @type {number}
     * @memberof ScriptResponse
     */
    organization?: number;
...
export function ScriptResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScriptResponse {
    ...
    return {
        ...
        'finalRating': json['final_rating'] == null ? undefined : json['final_rating'],
        'harmCategoryDangerousContentScore': json['harm_category_dangerous_content_score'] == null ? undefined : json['harm_category_dangerous_content_score'],
        'harmCategoryHarassmentScore': json['harm_category_harassment_score'] == null ? undefined : json['harm_category_harassment_score'],
        'harmCategoryHateSpeechScore': json['harm_category_hate_speech_score'] == null ? undefined : json['harm_category_hate_speech_score'],
        'harmCategorySexuallyExplicitScore': json['harm_category_sexually_explicit_score'] == null ? undefined : json['harm_category_sexually_explicit_score'],
...
export function ScriptResponseToJSON(value?: ScriptResponse | null): any {
    ...
    return {
        ...
        'final_rating': value['finalRating'],
        'harm_category_dangerous_content_score': value['harmCategoryDangerousContentScore'],
        'harm_category_harassment_score': value['harmCategoryHarassmentScore'],
        'harm_category_hate_speech_score': value['harmCategoryHateSpeechScore'],
        'harm_category_sexually_explicit_score': value['harmCategorySexuallyExplicitScore'],
        'id': value['id'],
        'name': value['name'],
