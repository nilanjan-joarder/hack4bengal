...
export interface CampaignRequest {
    ...
    phoneNumber: number;
    /**
     * Type of campaign, we have four types Outbound Bulk (blastout), Outbound AI (outbound), Inbound AI (inbound), Transactional (transactional)
     * @type {string}
     * @memberof CampaignRequest
     */
    ...
    script?: number;
    /**
     * Voice id. Can be found from the Voice Listing API. Head over to [Voice Garden](https://voices.callchimp.ai/) by Callchimp for samples.
     * @type {number}
     * @memberof CampaignRequest
     */
    voice?: number;
