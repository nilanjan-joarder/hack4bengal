 ...
 * 
 * @export
 * @interface CampaignFindRequest
 */
export interface CampaignFindRequest {
    /**
     * 
     * @type {string}
     * @memberof CampaignFindRequest
     */
    query?: string;
}
 ...
 */
export function instanceOfCampaignFindRequest(value: object): value is CampaignFindRequest {
    return true;
}

export function CampaignFindRequestFromJSON(json: any): CampaignFindRequest {
    return CampaignFindRequestFromJSONTyped(json, false);
}

export function CampaignFindRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CampaignFindRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CampaignFindRequestToJSON(value?: CampaignFindRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
