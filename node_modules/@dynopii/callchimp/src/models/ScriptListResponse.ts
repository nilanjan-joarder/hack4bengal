...
export interface ScriptListResponse {
    ...
    /**
     * 
     * @type {Array<ScriptResponse>}
     * @memberof ScriptListResponse
     */
    results?: Array<ScriptResponse>;
    /**
     * 
     * @type {number}
     * @memberof ScriptListResponse
 ...
 */
export function instanceOfScriptListResponse(value: object): value is ScriptListResponse {
    return true;
}

export function ScriptListResponseFromJSON(json: any): ScriptListResponse {
    return ScriptListResponseFromJSONTyped(json, false);
}

export function ScriptListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScriptListResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(ScriptResponseFromJSON)),
        'totalPages': json['total_pages'] == null ? undefined : json['total_pages'],
    };
}

export function ScriptListResponseToJSON(value?: ScriptListResponse | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(ScriptResponseToJSON)),
