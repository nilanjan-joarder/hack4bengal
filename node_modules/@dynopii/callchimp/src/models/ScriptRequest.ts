...
export interface ScriptRequest {
     ...
     * Name of the script
     * @type {string}
     * @memberof ScriptRequest
     */
    name?: string;
    /**
     * Script the bot should follow during the conversation
     * @type {string}
     * @memberof ScriptRequest
     */
    script?: string;
 ...
 */
export function instanceOfScriptRequest(value: object): value is ScriptRequest {
    return true;
}

export function ScriptRequestFromJSON(json: any): ScriptRequest {
    return ScriptRequestFromJSONTyped(json, false);
}

export function ScriptRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScriptRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ScriptRequestToJSON(value?: ScriptRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
