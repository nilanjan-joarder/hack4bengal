 ...
 */
export function instanceOfInboundCallListResponse(value: object): value is InboundCallListResponse {
    return true;
}
...
export function InboundCallListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InboundCallListResponse {
    ...
    return {
        ...
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(InboundCallResponseFromJSON)),
...
export function InboundCallListResponseToJSON(value?: InboundCallListResponse | null): any {
    ...
    return {
        ...
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(InboundCallResponseToJSON)),
