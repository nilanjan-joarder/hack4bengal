 ...
 * 
 * @export
 * @interface SubscriberUpdateRequest
 */
export interface SubscriberUpdateRequest {
    /**
     * 
     * @type {string}
     * @memberof SubscriberUpdateRequest
     */
    firstName?: string;
    /**
     * 
 ...
 */
export function instanceOfSubscriberUpdateRequest(value: object): value is SubscriberUpdateRequest {
    return true;
}

export function SubscriberUpdateRequestFromJSON(json: any): SubscriberUpdateRequest {
    return SubscriberUpdateRequestFromJSONTyped(json, false);
}

export function SubscriberUpdateRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SubscriberUpdateRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function SubscriberUpdateRequestToJSON(value?: SubscriberUpdateRequest | null): any {
    if (value == null) {
        return value;
    }
    return {
