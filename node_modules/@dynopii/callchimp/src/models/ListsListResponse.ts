 ...
 */
export function instanceOfListsListResponse(value: object): value is ListsListResponse {
    return true;
}
...
export function ListsListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ListsListResponse {
    ...
    return {
        ...
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(ListsResponseFromJSON)),
...
export function ListsListResponseToJSON(value?: ListsListResponse | null): any {
    ...
    return {
        ...
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(ListsResponseToJSON)),
