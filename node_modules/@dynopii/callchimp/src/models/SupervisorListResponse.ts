 ...
 */
export function instanceOfSupervisorListResponse(value: object): value is SupervisorListResponse {
    return true;
}
...
export function SupervisorListResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SupervisorListResponse {
    ...
    return {
        ...
        'results': json['results'] == null ? undefined : ((json['results'] as Array<any>).map(SupervisorResponseFromJSON)),
...
export function SupervisorListResponseToJSON(value?: SupervisorListResponse | null): any {
    ...
    return {
        ...
        'results': value['results'] == null ? undefined : ((value['results'] as Array<any>).map(SupervisorResponseToJSON)),
