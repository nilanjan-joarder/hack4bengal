 ...
 */
export function instanceOfCallReportResponse(value: object): value is CallReportResponse {
    return true;
}
...
export function CallReportResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CallReportResponse {
    ...
    return {
        ...
        'answeredCalls': json['answered_calls'] == null ? undefined : CallReportResponseAnsweredCallsFromJSON(json['answered_calls']),
        'campaignsCount': json['campaigns_count'] == null ? undefined : json['campaigns_count'],
        'queuedCalls': json['queued_calls'] == null ? undefined : CallReportResponseAnsweredCallsFromJSON(json['queued_calls']),
        'stats': json['stats'] == null ? undefined : ((json['stats'] as Array<any>).map(CallReportResponseStatsInnerFromJSON)),
        'totalCalls': json['total_calls'] == null ? undefined : CallReportResponseAnsweredCallsFromJSON(json['total_calls']),
        'totalDuration': json['total_duration'] == null ? undefined : CallReportResponseAnsweredCallsFromJSON(json['total_duration']),
    };
}
...
export function CallReportResponseToJSON(value?: CallReportResponse | null): any {
    ...
    return {
        ...
        'stats': value['stats'] == null ? undefined : ((value['stats'] as Array<any>).map(CallReportResponseStatsInnerToJSON)),
