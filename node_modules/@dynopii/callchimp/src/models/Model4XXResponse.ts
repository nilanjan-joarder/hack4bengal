...
export function Model4XXResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Model4XXResponse {
    ...
    return {
        ...
        'errors': json['errors'] == null ? undefined : ((json['errors'] as Array<any>).map(Model4XXResponseErrorsInnerFromJSON)),
    };
}
...
export function Model4XXResponseToJSON(value?: Model4XXResponse | null): any {
    ...
    return {
        ...
        'type': value['type'],
        'errors': value['errors'] == null ? undefined : ((value['errors'] as Array<any>).map(Model4XXResponseErrorsInnerToJSON)),
    };
}
